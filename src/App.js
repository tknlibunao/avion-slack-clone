...
function App() {
	...
	const getMyChannels = () => {
		...
		fetch(`${url}/channel/owned`, requestOptions)
			...
			.then((result) => {
				...
				// console.log('OWNED CHANNELS: ', updatedList);
	...
	// arrange users list by id (least to greatest)
	...
	const getDMs = () => {
		...
		fetch('http://206.189.91.54//api/v1/users/recent', requestOptions)
			...
			.then((result) => {
				...
				// console.log('RECENT DMs: ', updatedList);
	...
	const getAllChannels = () => {
		...
		fetch('http://206.189.91.54//api/v1/channels', requestOptions)
			...
			.then((result) => {
				...
				// console.log('ALL CHANNELS: ', updatedList);
